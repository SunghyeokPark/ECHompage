				...
				<div class="col-md-10">
					<div class="row">
						...
						<div class="col-sm-3 intro-btn">
							<h3><a href="#">소개 <span class="glyphicon glyphicon-chevron-right list-bullet"></span></a></h3>
						</div>
					</div>
				</div>
				<div class="col-md-1 hidden-xs hidden-sm"></div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 notice-content">
					<div class="row">
						<div class="col-sm-4">
							<h3><a href="#">공지사항 <span class="glyphicon glyphicon-chevron-right list-bullet"></span></a></h3>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-10">
					<div class="row">
							...
							<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								  ...
								  <div class="carousel-inner" role="listbox">
								    <div class="item active">
								      <div style="background-image: url(img/test1.jpg); background-size:100%; background-position: 0px 0px;">
								    ...
								    <div class="item">
								      <div style="background-image: url(img/test2.jpg); background-size:100%; background-position: 0px 0px;">
										<img src="img/transparent.png" style="width: 100%;  min-height: 180px;" />
									  </div>
								      <div class="carousel-caption">
								      	<h3>문구인데</h3>
						...
						<div class="col-sm-3">
							<div class="row">
								<div class="col-xs-6 col-sm-12 etc-btn">
									<h3><a href="#">자유게시판 <span class="glyphicon glyphicon-chevron-right list-bullet"></span></a></h3>
								</div>
								
								
								<div class="col-xs-6 col-sm-12 etc-btn etc-btn-yellow">
									<h3><a href="#">SOS <span class="glyphicon glyphicon-chevron-right list-bullet"></span></a></h3>
								</div>
							</div>
